 ...
 * HTML by default, so the blog copy is safe to render. The wrapper carries all
 * article typography as Tailwind arbitrary-value child selectors — no new
 * `globals.css` classes (matching the About / Blog Listing rebuilds).
 *
